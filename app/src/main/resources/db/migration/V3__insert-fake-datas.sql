...
INSERT INTO tbl_groups VALUES (1, 'Pessoal', 1);
    INSERT INTO tbl_bank_accounts VALUES(1, 'CHECKING','NuBank', 'Conta Corrente do NuBank', 2, 'nubank.svg', 1045.48, 1, 0.0, 0, null,null,null);
        ...
        INSERT INTO tbl_transactions VALUES (4,11,1,1, 1,'2026-04-04 21:43:12','Salgados e café',-26.90, 'EXPENSE', NULL, NULL);
        INSERT INTO tbl_transactions VALUES (5,13,1,1, 4,'2026-04-20 07:53:01','Almoço',-26.12, 'EXPENSE', NULL, NULL);
        INSERT INTO tbl_transactions VALUES (6,8,1,4, null,'2026-04-19 09:37:10','Happy Hour da Empresa', -57.50, 'EXPENSE', NULL, NULL);
        INSERT INTO tbl_transactions VALUES (7,12,1,7, 10,'2026-04-18 09:37:10','Medicamentos', -232.50, 'EXPENSE', NULL, NULL);
        INSERT INTO tbl_transactions VALUES (8,3,1,12, 12,'2026-03-08 23:04:21','Regularização da Construção', 950.00, 'GAIN', NULL, NULL);
            INSERT INTO tbl_transaction_tag VALUES (8, 5);
        INSERT INTO tbl_transactions VALUES (9,7,1,1, 1,'2026-03-08 17:14:31','Salgados e café', -8.40, 'EXPENSE', NULL, NULL);
            INSERT INTO tbl_transaction_tag VALUES (9, 7);
            INSERT INTO tbl_transaction_tag VALUES (9, 9);
        INSERT INTO tbl_transactions VALUES (10,9,1,1, 3,'2026-03-20 14:10:38','Almoço',-23.50, 'EXPENSE', NULL, NULL);
        INSERT INTO tbl_transactions VALUES (11,18,1,9, 7,'2026-03-06 13:29:41','Gasolina', -182.00, 'EXPENSE', NULL, NULL);
            INSERT INTO tbl_transaction_tag VALUES (11, 7);
        INSERT INTO tbl_transactions VALUES (12,6,1,2, 15,'2026-03-24 13:29:41','Monitor Asus', -299.90, 'EXPENSE', NULL, NULL);
            INSERT INTO tbl_transaction_tag VALUES (12, 2);
            INSERT INTO tbl_transaction_tag VALUES (12, 5);
        INSERT INTO tbl_transactions VALUES (13,6,1,3, 5,'2026-03-24 13:29:41','Livro Código Limpo', -99.90, 'EXPENSE', NULL, NULL);
            INSERT INTO tbl_transaction_tag VALUES (13, 2);
        INSERT INTO tbl_transactions VALUES (14,7,1,9, 7,'2026-03-19 13:29:41','Gasolina', -196.00, 'EXPENSE', NULL, NULL);
        INSERT INTO tbl_transactions VALUES (15,4,1,12, 12,'2026-02-08 19:49:48','Parecer Técnico - Parcela 1/2', 200.00, 'GAIN', NULL, NULL);
            INSERT INTO tbl_transaction_tag VALUES (15, 3);
            INSERT INTO tbl_transaction_tag VALUES (15, 5);
        INSERT INTO tbl_transactions VALUES (16,15,1,1, 1,'2026-02-09 22:16:56','Frango Assado', -42.30, 'EXPENSE', NULL, NULL);
