...
class FetchSpendingPaceUseCase(private val transactionDao: TransactionDao = TransactionDao()) {
    ...
    fun execute(
        ...
        val monthTotal = transactionDao.getByDateRange(mtdStart, mtdEnd, TransactionType.EXPENSE)
        ...
        val baselineTxs = transactionDao.getByDateRange(baselineStart, baselineEnd, TransactionType.EXPENSE)
